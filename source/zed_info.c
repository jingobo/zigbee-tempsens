...
CONST zclAttrRec_t ZED_INFO_ATTRIBUTES[] =
{
    ...
    ZED_INFO_ATTR(ZCL_CLUSTER_ID_GEN_POWER_CFG,                 ATTRID_POWER_CFG_BATTERY_VOLTAGE,               ZCL_DATATYPE_UINT8,     ACCESS_CONTROL_READ,                            &sens_bat_volatage),
    ZED_INFO_ATTR(ZCL_CLUSTER_ID_GEN_POWER_CFG,                 ATTRID_POWER_CFG_BATTERY_PERCENTAGE_REMAINING,  ZCL_DATATYPE_UINT8,     ACCESS_CONTROL_READ | ACCESS_REPORTABLE,        &sens_bat_precentage),
    ...
    ZED_INFO_ATTR(ZCL_CLUSTER_ID_MS_TEMPERATURE_MEASUREMENT,    ATTRID_MS_TEMPERATURE_MEASURED_VALUE,           ZCL_DATATYPE_INT16,     ACCESS_CONTROL_READ | ACCESS_REPORTABLE,        &sens_temp_current),
    ZED_INFO_ATTR(ZCL_CLUSTER_ID_MS_TEMPERATURE_MEASUREMENT,    ATTRID_MS_TEMPERATURE_MIN_MEASURED_VALUE,       ZCL_DATATYPE_INT16,     ACCESS_CONTROL_READ,                            &SENS_TEMP_RANGE_MIN),
    ZED_INFO_ATTR(ZCL_CLUSTER_ID_MS_TEMPERATURE_MEASUREMENT,    ATTRID_MS_TEMPERATURE_MAX_MEASURED_VALUE,       ZCL_DATATYPE_INT16,     ACCESS_CONTROL_READ,                            &SENS_TEMP_RANGE_MAX),
    ZED_INFO_ATTR(ZCL_CLUSTER_ID_MS_TEMPERATURE_MEASUREMENT,    ATTRID_MS_TEMPERATURE_TOLERANCE,                ZCL_DATATYPE_UINT16,    ACCESS_CONTROL_READ,                            &SENS_TEMP_TOLERANCE),
